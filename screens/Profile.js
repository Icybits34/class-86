...
export default class Profile extends Component {
  ...
  toggleSwitch() {
    ...
    var updates = {}
    updates["/users/" + firebase.auth().currentUser.uid] = theme
  ...
  async fetchUser() {
    ...
    await firebase
      ...
      .on("value", function (snapshot) { theme = snapshot.val().current_theme; name = `${snapshot.val().first_name} ${snapshot.val().last_name}`; });
      this.setState({
